...
import org.inferneon.bayesnet.hillclimber.HillClimber;
...
/**
 *
 * Java test cases for the local Hill climbing algorithm to learn a network. For now, just for the purpose of illustration.
 */
public class HillClimberTests {
    ...
    public void test1() {
        ...
        BayesianBeliefNetwork network = HillClimber.learnNetwork(rawInput, 2, 0.5, false, 3, true, schema, ScoringType.ENTROPY());
